            ...
            <div class="col-md-6">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">Add New Location</h6>
                        </div>
...
'redirectTo'   => route('locations.index'),
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            {{ Form::label('postal_code (format example: A1A 1A1)'), ['class' => 'control-label mb-10 text-left'] }}
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {{ Form::select('parent_location', $locationList , null, ['class' => 'form-control']) }}
                                        </div>
                                    </div>
